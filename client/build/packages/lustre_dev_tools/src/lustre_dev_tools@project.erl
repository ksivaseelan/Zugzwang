...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 101).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 97).
-spec root() -> binary().
root() ->
    find_root(<<"."/utf8>>).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 110).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 163).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 155).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 169).
-spec string_dict(
    fun((gleam@dynamic:dynamic_()) -> {ok, XRU} |
        {error, list(gleam@dynamic:decode_error())})
) -> fun((gleam@dynamic:dynamic_()) -> {ok, gleam@dict:dict(binary(), XRU)} |
    {error, list(gleam@dynamic:decode_error())}).
string_dict(Values) ->
    gleam@dynamic:dict(fun gleam@dynamic:string/1, Values).

-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 144).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 135).
