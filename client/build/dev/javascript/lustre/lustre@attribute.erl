...
-spec on(
    binary(),
    fun((gleam@dynamic:dynamic_()) -> {ok, ORX} |
        {error, list(gleam@dynamic:decode_error())})
) -> lustre@internals@vdom:attribute(ORX).
on(Name, Handler) ->
    {event, <<"on"/utf8, Name/binary>>, Handler}.

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 63).
-spec map(lustre@internals@vdom:attribute(OSC), fun((OSC) -> OSE)) -> lustre@internals@vdom:attribute(OSE).
map(Attr, F) ->
    case Attr of
...
-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 365).
-spec charset(binary()) -> lustre@internals@vdom:attribute(any()).
charset(Name) ->
    attribute(<<"charset"/utf8>>, Name).

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 370).
