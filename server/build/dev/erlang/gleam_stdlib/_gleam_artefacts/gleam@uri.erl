...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 116).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 126).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 137).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 178).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 173).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 145).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 56).
-spec parse(binary()) -> {ok, uri()} | {error, nil}.
parse(Uri_string) ->
    gleam_stdlib:uri_parse(Uri_string).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 198).
-spec parse_query(binary()) -> {ok, list({binary(), binary()})} | {error, nil}.
parse_query(Query) ->
    gleam_stdlib:parse_query(Query).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 242).
-spec percent_encode(binary()) -> binary().
percent_encode(Value) ->
    gleam_stdlib:percent_encode(Value).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 225).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 217).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 259).
-spec percent_decode(binary()) -> {ok, binary()} | {error, nil}.
percent_decode(Value) ->
    gleam_stdlib:percent_decode(Value).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 267).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 286).
-spec remove_dot_segments(list(binary())) -> list(binary()).
remove_dot_segments(Input) ->
    do_remove_dot_segments(Input, []).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 302).
-spec path_segments(binary()) -> list(binary()).
path_segments(Path) ->
    remove_dot_segments(gleam@string:split(Path, <<"/"/utf8>>)).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 318).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 362).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 379).
-spec drop_last(list(FKT)) -> list(FKT).
drop_last(Elements) ->
    gleam@list:take(Elements, erlang:length(Elements) - 1).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 383).
-spec join_segments(list(binary())) -> binary().
join_segments(Segments) ->
    gleam@string:join([<<""/utf8>> | Segments], <<"/"/utf8>>).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/uri.gleam", 393).
