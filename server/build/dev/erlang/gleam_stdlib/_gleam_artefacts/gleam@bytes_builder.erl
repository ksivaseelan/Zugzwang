...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 72).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 60).
-spec prepend_builder(bytes_builder(), bytes_builder()) -> bytes_builder().
prepend_builder(Second, First) ->
    gleam_stdlib:iodata_append(First, Second).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 111).
-spec concat(list(bytes_builder())) -> bytes_builder().
concat(Builders) ->
    gleam_stdlib:identity(Builders).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 36).
-spec new() -> bytes_builder().
new() ->
    gleam_stdlib:identity([]).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 132).
-spec from_string(binary()) -> bytes_builder().
from_string(String) ->
    gleam_stdlib:wrap_list(String).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 87).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 99).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 142).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 151).
-spec from_bit_array(bitstring()) -> bytes_builder().
from_bit_array(Bits) ->
    gleam_stdlib:wrap_list(Bits).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 44).
-spec prepend(bytes_builder(), bitstring()) -> bytes_builder().
prepend(Second, First) ->
    gleam_stdlib:iodata_append(gleam_stdlib:wrap_list(First), Second).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 52).
-spec append(bytes_builder(), bitstring()) -> bytes_builder().
append(First, Second) ->
    gleam_stdlib:iodata_append(First, gleam_stdlib:wrap_list(Second)).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 120).
-spec concat_bit_arrays(list(bitstring())) -> bytes_builder().
concat_bit_arrays(Bits) ->
    gleam_stdlib:identity(Bits).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 170).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 163).
-spec to_bit_array(bytes_builder()) -> bitstring().
to_bit_array(Builder) ->
    erlang:list_to_bitstring(Builder).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 197).
