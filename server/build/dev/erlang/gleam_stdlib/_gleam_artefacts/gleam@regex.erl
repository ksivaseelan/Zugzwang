...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/regex.gleam", 55).
-spec compile(binary(), options()) -> {ok, regex()} | {error, compile_error()}.
compile(Pattern, Options) ->
    gleam_stdlib:compile_regex(Pattern, Options).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/regex.gleam", 92).
-spec from_string(binary()) -> {ok, regex()} | {error, compile_error()}.
from_string(Pattern) ->
    compile(Pattern, {options, false, false}).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/regex.gleam", 111).
-spec check(regex(), binary()) -> boolean().
check(Regex, String) ->
    gleam_stdlib:regex_check(Regex, String).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/regex.gleam", 129).
-spec split(regex(), binary()) -> list(binary()).
split(Regex, String) ->
    gleam_stdlib:regex_split(Regex, String).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/regex.gleam", 189).
-spec scan(regex(), binary()) -> list(match()).
scan(Regex, String) ->
    gleam_stdlib:regex_scan(Regex, String).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_stdlib/src/gleam/regex.gleam", 215).
