...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 74).
-spec new(strategy()) -> builder().
new(Strategy) ->
    {builder, Strategy, 2, 5, never, []}.

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 94).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 104).
-spec auto_shutdown(builder(), auto_shutdown()) -> builder().
auto_shutdown(Builder, Value) ->
    erlang:setelement(5, Builder, Value).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 184).
-spec add(builder(), child_builder()) -> builder().
add(Builder, Child) ->
    erlang:setelement(6, Builder, [Child | erlang:element(6, Builder)]).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 197).
-spec worker_child(
    binary(),
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 219).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 241).
-spec significant(child_builder(), boolean()) -> child_builder().
significant(Child, Significant) ->
    erlang:setelement(5, Child, Significant).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 252).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 263).
-spec restart(child_builder(), restart()) -> child_builder().
restart(Child, Restart) ->
    erlang:setelement(4, Child, Restart).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 293).
-spec property(
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 267).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 165).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/static_supervisor.gleam", 303).
