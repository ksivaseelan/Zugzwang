...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/intensity_tracker.gleam", 14).
-spec new(integer(), integer()) -> intensity_tracker().
new(Limit, Period) ->
    {intensity_tracker, Limit, Period, []}.

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/intensity_tracker.gleam", 21).
-spec now_seconds() -> integer().
now_seconds() ->
    erlang:monotonic_time(1).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/intensity_tracker.gleam", 25).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_otp/src/gleam/otp/intensity_tracker.gleam", 36).
