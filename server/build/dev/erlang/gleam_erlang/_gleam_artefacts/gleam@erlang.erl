...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 17).
-spec format(any()) -> binary().
format(Term) ->
    unicode:characters_to_binary(io_lib:format(<<"~p"/utf8>>, [Term])).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 27).
-spec term_to_binary(any()) -> bitstring().
term_to_binary(A) ->
    erlang:term_to_binary(A).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 80).
-spec get_line(binary()) -> {ok, binary()} | {error, get_line_error()}.
get_line(Prompt) ->
    gleam_erlang_ffi:get_line(Prompt).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 93).
-spec system_time(time_unit()) -> integer().
system_time(A) ->
    os:system_time(A).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 99).
-spec erlang_timestamp() -> {integer(), integer(), integer()}.
erlang_timestamp() ->
    os:timestamp().

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 109).
-spec rescue(fun(() -> HLB)) -> {ok, HLB} | {error, crash()}.
rescue(A) ->
    gleam_erlang_ffi:rescue(A).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 41).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 56).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 124).
-spec start_arguments() -> list(binary()).
start_arguments() ->
    _pipe = init:get_plain_arguments(),
    gleam@list:map(_pipe, fun unicode:characters_to_binary/1).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 147).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 170).
-spec make_reference() -> reference_().
make_reference() ->
    erlang:make_ref().

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 191).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 208).
