...
-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang/atom.gleam", 42).
-spec from_string(binary()) -> {ok, atom_()} | {error, from_string_error()}.
from_string(A) ->
    gleam_erlang_ffi:atom_from_string(A).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang/atom.gleam", 54).
-spec create_from_string(binary()) -> atom_().
create_from_string(A) ->
    erlang:binary_to_atom(A).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang/atom.gleam", 67).
-spec to_string(atom_()) -> binary().
to_string(A) ->
    erlang:atom_to_binary(A).

-file("/home/kogul/projects/gleam/chess/server/build/packages/gleam_erlang/src/gleam/erlang/atom.gleam", 84).
