...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 11).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 20).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 26).
-spec accept(glisten@socket:listen_socket()) -> {ok, glisten@socket:socket()} |
    {error, glisten@socket:socket_reason()}.
accept(Socket) ->
    ssl:transport_accept(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 29).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 36).
-spec 'receive'(glisten@socket:socket(), integer()) -> {ok, bitstring()} |
    {error, glisten@socket:socket_reason()}.
'receive'(Socket, Length) ->
    ssl:recv(Socket, Length).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 39).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 42).
-spec close(glisten@socket:socket()) -> {ok, nil} |
    {error, glisten@socket:socket_reason()}.
close(Socket) ->
    glisten_ssl_ffi:close(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 45).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 47).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 56).
-spec set_opts(
    glisten@socket:socket(),
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 68).
-spec handshake(glisten@socket:socket()) -> {ok, glisten@socket:socket()} |
    {error, nil}.
handshake(Socket) ->
    ssl:handshake(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 71).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 81).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 84).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 87).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 90).
-spec start() -> {ok, nil} | {error, gleam@dynamic:dynamic_()}.
start() ->
    glisten_ssl_ffi:start_ssl().

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/ssl.gleam", 93).
