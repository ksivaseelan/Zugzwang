...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 11).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 20).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 26).
-spec accept(glisten@socket:listen_socket()) -> {ok, glisten@socket:socket()} |
    {error, glisten@socket:socket_reason()}.
accept(Socket) ->
    gen_tcp:accept(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 29).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 36).
-spec 'receive'(glisten@socket:socket(), integer()) -> {ok, bitstring()} |
    {error, glisten@socket:socket_reason()}.
'receive'(Socket, Length) ->
    gen_tcp:recv(Socket, Length).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 39).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 42).
-spec socket_info(glisten@socket:socket()) -> gleam@dict:dict(any(), any()).
socket_info(Socket) ->
    socket:info(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 45).
-spec close(any()) -> {ok, nil} | {error, glisten@socket:socket_reason()}.
close(Socket) ->
    glisten_tcp_ffi:close(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 48).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 50).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 59).
-spec set_opts(
    glisten@socket:socket(),
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 68).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 77).
-spec handshake(glisten@socket:socket()) -> {ok, glisten@socket:socket()} |
    {error, nil}.
handshake(Socket) ->
    {ok, Socket}.

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 82).
-spec negotiated_protocol(glisten@socket:socket()) -> any().
negotiated_protocol(Socket) ->
    tcp:negotiated_protocol(Socket).

-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 85).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 88).
...
-file("/home/kogul/projects/gleam/chess/server/build/packages/glisten/src/glisten/tcp.gleam", 94).
